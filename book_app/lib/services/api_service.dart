...
class ApiService {
  ...
  // Simple in-memory token storage (for web compatibility)
  ...
  Future<Map<String, dynamic>> get(String endpoint,
    ...
    try {
      ...
      print(
          '[API Response] ${response.statusCode}: ${response.body.substring(0, response.body.length.clamp(0, 200))}'); // Debug
  ...
  Future<Map<String, dynamic>> delete(String endpoint,
    ...
    try {
      final headers = requireAuth ? await _authHeaders : _headers;
      final response =
          await http.delete(Uri.parse(_url(endpoint)), headers: headers);
      return _handleResponse(response);
    } catch (e) {
